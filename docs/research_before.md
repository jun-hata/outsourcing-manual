...
販売実績が確認できる商品は、需要が安定している可能性が高く、継続的に販売できる傾向があります。

そのため、  
<span class="red-text">必ず販売履歴を確認し、基準を満たしている商品に絞ってリサーチを行いましょう。</span>
...
<span class="red-text">この基準を必ず守るようにしてください。</span>
