...
### STEP③ 出力された「特定スペック」と「一言補足情報」を確認（違和感チェック）

AIが判定結果を出力したら、**「0. 特定したスペック・商品情報」** および **「3. 一言補足情報」** を必ず確認してください。  
...
出力された「確認ソース（URL）」や「一言補足情報」を見て、<span class="red-text">明らかに仕入れ元商品と違う製品情報になっている場合</span>は、型番やメーカー名を詳しく追記して再度判定させてください。
